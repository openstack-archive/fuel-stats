...
"""action_type action_name columns added
...
def upgrade():
    ...
    op.add_column('action_logs', sa.Column('action_type', sa.Text(),
                                           nullable=True))
    op.create_index(op.f('ix_action_logs_action_name'), 'action_logs',
                    ['action_name'], unique=False)
    op.create_index(op.f('ix_action_logs_action_type'), 'action_logs',
