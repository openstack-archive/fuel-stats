...
class BaseRequestTemplate(object):
    ...
    def __init__(self):
        ...
        self.master_node_uid = self.random_sha
...
class InstallationRequestTemplate(BaseRequestTemplate):
    ...
    def __init__(self, max_clusters_count=10, max_cluster_size=100):
        ...
        self.url = "/api/v1/installation_struct/"

    @property
    def clusters_number(self):
        return random.randrange(1, self.max_clusters_count)

    @property
    def nodes_number(self):
        return random.randrange(1, self.max_cluster_size)
    ...
    def get_request_body(self):
        ...
        data = {
            "installation_struct": {
                "master_node_uid": self.master_node_uid,
...
class ActionLogRequestTemplate(BaseRequestTemplate):
    ...
    def get_request_body(self):
        ...
        for id in xrange(1, self.max_logs_count):
